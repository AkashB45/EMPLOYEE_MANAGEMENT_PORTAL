...
import { FaHome, FaInfo, FaServicestack, FaEnvelope, FaBars, FaTimes } from 'react-icons/fa';
            ...
            <div className="flex-1">
              <ul className="pt-2 pb-4 space-y-1 text-sm">
                <li className="rounded-sm">
                  <Link to={"/DashBoard"} className="flex items-center p-2 space-x-3 rounded-md hover:bg-gray-700">
                    <FaHome />
                    <span>Dashboard</span>
                  </Link>
                </li>
