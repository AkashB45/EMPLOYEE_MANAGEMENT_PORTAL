...
const UserDashboard = () => {
  ...
  return (
    <Container className="mt-4">
      <h1 className="font-bold text-3xl text-center mb-8 text-[#071952]">USER Dashboard</h1>
      <Row className="mb-8">
      ...
      <Row className="mb-8">
        ...
        <Col md={6} sm={12}>
          <div className="w-full h-64">
            <br></br><br></br>
            <h2 className="text-lg font-bold mb-4 text-center text-[#071952]">Applications Over Time</h2>
